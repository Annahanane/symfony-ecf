...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function isEnableds(): ?bool
    {
        return $this->enableds;
    }

    public function setEnableds(bool $enableds): self
    {
    ...
    public function setBorrower(Borrower $borrower): self
    {
        ...
        if ($borrower->getUsers() !== $this) {
            $borrower->setUsers($this);
        }
